...
// To parse this data:
//
//   import { Convert, WeatherInfo } from "./file";
//
//   const weatherInfo = Convert.toWeatherInfo(json);
//
...
export class Convert {
    public static toWeatherInfo(json: string): WeatherInfo {
        return cast(JSON.parse(json), r("WeatherInfo"));
    }

    public static weatherInfoToJson(value: WeatherInfo): string {
        return JSON.stringify(uncast(value, r("WeatherInfo")), null, 2);
    }
}
